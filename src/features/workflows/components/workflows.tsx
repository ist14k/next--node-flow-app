...
export const WorkflowItem: React.FC<{ data: Workflow }> = ({ data }) => {
  ...
  return (
    <EntityItem
      ...
      subtitle={
        <>
          Update {formatDistanceToNow(new Date(data.updatedAt))} ago &bull;
          Created {formatDistanceToNow(new Date(data.createdAt))} ago
        </>
      }
      image={
